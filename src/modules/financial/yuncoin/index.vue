<template>
	<section>
		<div class="tap">
			<span class="balance active">账户余额：{{balanceInfo.balance}}云贝</span>
			<span class="balance">冻结：{{balanceInfo.frozen}}云贝</span>
			<span class="balance">预付款：{{balanceInfo.advance}}云贝</span>
		</div>
		...
		<div class="tap">
			<span class="balance">总收入：{{inOutInfo[0]}}云贝</span>
			<span class="balance">总支出：{{inOutInfo[1]}}云贝</span>
		</div>
